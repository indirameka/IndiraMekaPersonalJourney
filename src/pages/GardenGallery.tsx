...
const photos = [
  { src: garden1, caption: "Spring bloom in the raised beds" },
  { src: garden2, caption: "Heirloom tomatoes ready for harvest" },
  { src: garden3, caption: "Wildflower meadow corner" },
  { src: garden4, caption: "Fresh vegetables from the garden" },
  { src: garden5, caption: "Early morning garden light" },
  { src: garden6, caption: "Companion planting in full swing" },
];
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Seasons of patience, colour, and abundance — moments captured from
            my organic garden sanctuary.
          </p>
        </div>
